...
const FALLBACK_PROJECTS: Project[] = [
  {
    ...
    description: 'Modern full-stack blog platform with real-time analytics, content management, and advanced security. Features SEO optimization, responsive design, and secure authentication. AI-powered weekly content generation with DevOps, Cloud, and Security insights.',
    technologies: ['Next.js 13+', 'React', 'TypeScript', 'Tailwind CSS', 'Supabase', 'PostgreSQL', 'Cloudflare', 'Vercel', 'Google Gemini', 'Tavily Search'],
  ...
  },
  {
    ...
    description: 'Full-featured e-commerce solution with shopping cart, product management, inventory tracking, and secure payment integration. Mobile-responsive design for better UX and optimal conversion rates.',
  ...
  },
  {
    ...
    description: 'Enterprise-grade facility management system for maintenance operations, scheduling, resource allocation, and team management. Built for professional service providers with real-time tracking and reporting.',
              ...
              <div className="flex gap-3 mt-auto pt-4">
                {project.link && (
                  <a
                    ...
                    className="flex items-center gap-2 px-4 py-2 rounded-lg bg-violet-600 hover:bg-violet-700 text-white transition-colors flex-1 justify-center"
                  >
